...
import com.example.binaural_audio_engine.BinauralAudioEngine
 ...
 * - setHarmonicRichness: Set harmonic richness (Phase 2)
 * - setDriftIntensity: Set drift intensity (Phase 2)
 * - setBrownNoiseWarmth: Set brown noise warmth (Phase 2)
 * - setBrownNoiseTexture: Set brown noise texture (Phase 2)
 * - setPadLayerEnabled: Enable/disable pad layer (Phase 2)
 * - setPsychoacousticSmoothing: Enable/disable psychoacoustic smoothing (Phase 2)
 * - setRootNote: Set root note frequency (Phase 3)
 * - setTuningReference: Set tuning reference 432Hz/440Hz (Phase 3)
 * - setHarmonicDensity: Set harmonic density (Phase 3)
 * - setEvolutionSpeed: Set evolution speed (Phase 3)
 * - setStereoWidth: Set stereo width (Phase 3)
 * - setSaturationAmount: Set saturation amount (Phase 3)
 * - setPadIntensity: Set pad intensity (Phase 3)
 * - setEmotionalMode: Set emotional mode (Phase 3)
 */
    ...
    override fun configureFlutterEngine(flutterEngine: FlutterEngine) {
        ...
        MethodChannel(flutterEngine.dartExecutor.binaryMessenger, CHANNEL).setMethodCallHandler { call, result ->
            when (call.method) {
                ...
                "setEmotionalMode" -> {
                    val mode = call.argument<Int>("mode") ?: 1 // Default: CALM
